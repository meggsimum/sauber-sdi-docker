...
docker tag sauberprojekt/test_messenger:$MASTER_TAG sauberprojekt/lubw_download:$DATE_TAG

docker build --rm -f "lanuv_download/Dockerfile" -t sauberprojekt/lanuv_download:$MASTER_TAG "lanuv_download"
docker tag sauberprojekt/test_messenger:$MASTER_TAG sauberprojekt/lanuv_download:$DATE_TAG
